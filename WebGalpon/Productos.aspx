...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server" >
    ...
    <hr />
   <div class="contact-form">
        <div class="cardflex" style="display:grid; " >
  ...
  <div class="card" style=" align-items:center; text-align:center;">
    ...
    <div class="card-body">
      ...
      <a href="DetalleProducto.aspx?id=<% = item.Codigo%>" class="btn btn-dark btn-sm">Ver Detalle</a>
        <a href="Carrito.aspx?id=<% = item.Codigo %>"class="btn btn-dark btn-sm" style="margin:1vh;">Agregar <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
