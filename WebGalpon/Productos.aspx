  ...
  <div class="card" style="height:250px; align-items:center; margin-right:15px; margin-bottom:15px; text-align:center;">
    ...
    <div class="card-body">
      ...
      <a href="DetalleProducto.aspx?id=<% = item.Codigo%>" class="btn btn-dark btn-sm">Ver Detalle</a>
        <a href="Carrito.aspx?id=<% = item.ImagenUrl %>"class="btn btn-secondary">Agregar <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
