...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server" >
    ...
    <div class="breadcrumb">
        ...
        <a class="link" id="linkwpp" href="https://api.whatsapp.com/send?text=[text]"><svg id="s3" xmlns="http://www.w3.org/2000/svg" style="padding:10px 15px;color: #25D366" width="90" height="90" fill="|Color" class="bi bi-whatsapp" viewBox="0 0 16 16">
